var RPCClient = (function () {
  ...
  function (_Message) {
    ...
    _createClass(ErrorMessage, [{
      key: "toJson",
      value: function toJson() {
        return _objectSpread2({}, _get(_getPrototypeOf(ErrorMessage.prototype), "toJson", this).call(this), {
          error: this.error,
          id: this.id
        });
      }
  ...
  function (_Message) {
    ...
    _createClass(RequestMessage, [{
      key: "toJson",
      value: function toJson() {
        return _objectSpread2({}, _get(_getPrototypeOf(RequestMessage.prototype), "toJson", this).call(this), {
          method: this.method,
          params: this.params,
          id: this.id
        });
  ...
  function (_Message) {
    ...
    _createClass(ResponseMessage, [{
      key: "toJson",
      value: function toJson() {
        return _objectSpread2({}, _get(_getPrototypeOf(ResponseMessage.prototype), "toJson", this).call(this), {
          result: this.result,
          id: this.id
        });
      }
  ...
  function (_EventEmitter) {
    ...
    function Reciever() {
      ...
      _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(Reciever)).call.apply(_getPrototypeOf2, [this].concat(args)));
      ...
      _defineProperty(_assertThisInitialized(_this), "onMessage", function (string) {
        ...
        var messages = Reciever._toMessages(json);
      ...
      _defineProperty(_assertThisInitialized(_this), "_parseMessage", function (message) {
        ...
        try {
          ...
          return _this.emit('error', new ParseError(parseError.message));
        }
