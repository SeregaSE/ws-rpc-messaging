...
const proxyEvents$1 = ['close', 'headers', 'listening'];
...
class RPCServer extends EventEmitter {
  constructor(...args) {
    ...
    _defineProperty(this, "createOnClientError", client => error => {
      this.emit('error', error, client, this);
    });

    _defineProperty(this, "createOnClientRequest", client => request => {
